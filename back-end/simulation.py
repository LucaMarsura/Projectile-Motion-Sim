...
def simul(true_ivelocity,true_iheight,true_iangle,true_gravity,true_mass,true_density,true_cd,true_area):
    ...
    while float(instheight) > 0:
        instvelocity_y -= ((true_mass * true_gravity) - (1/2 * true_density * true_cd * true_area * instvelocity_y ** 2)) / true_mass * 0.01
        instvelocity_x -= (1/2 * true_density * true_cd * true_area * instvelocity_x ** 2) / true_mass * 0.01
        instvelocity = math.sqrt(instvelocity_x ** 2 + instvelocity_y ** 2)
        instheight += instvelocity_y * 0.01
        instdistance += instvelocity_x * 0.01
